		...
		<div class="container">
			<div class="row car">
				...
				<div class="col-md-6">
					...
					<ul class="car-list">
						<li><i class="fa fa-bus"></i><strong> Modelo: </strong> Toyota hiace</li>
						<li><i class="fa fa-users"></i><strong> Capacidad: </strong> 15 Personas</li>
						<li><i class="fa fa-refresh fa-spin  fa-fw margin-bottom"></i><strong>A/C: </strong> Si</li>
						<li><i class="fa fa-tv"></i><strong> Television: </strong> 1 tv 32 ft</li>
						<li><i class="fa fa-volume-up"></i><strong>  Audio: </strong> Estereo soni 6000 whats</li>				
					</ul>
				</div>
			</div>	
			
			<div class="testmonial col-sm-12" style="background-color: transparent;"> 
		    	...
		    	<div class="col-md-6">
		    		<ul class="test_box">
						...
						<li class="test_desc">
							...
							<a href="camioneta.html" class="test_btn">   + ver mas</a></p>
					    </li>	
					    <div class="clearfix">	</div>    		    				
		    		</ul>
		    	</div>
