...
<img src="<?= PUBLIC_PATH ?>assets/images/vans/<?= $value['imagen'] ?>" class="img-responsive"/> 


                </li>
				<li class="test_desc">
					<h4><a href="<?= PUBLIC_PATH ?>camioneta?c=<?= $value['camid'] ?>"><?= $value['marca'] ?></a></h4>
					<p><?= $value['descripcion'] ?><a href="<?= PUBLIC_PATH ?>camioneta?c=<?= $value['camid'] ?>" class="test_btn">   + ver mas</a></p>
			    </li>	
